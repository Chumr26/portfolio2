  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm border-b border-[#484848]/50">
      <div className="container mx-auto px-4 md:px-[60px] py-[24px] flex items-center justify-between">
        <Link to="/" className="font-['JetBrains_Mono'] leading-[1.5] text-[#c7c7c7] text-[28px] md:text-[32px] tracking-[-0.32px] hover:text-white transition-colors">
          robert garcia
        </Link>

        {/* Desktop Navigation */}
        <div className="hidden md:flex gap-[32px] items-center font-['JetBrains_Mono'] font-medium text-[16px]">
          <Link
            to="/"
            className={`leading-[1.6] transition-colors ${
              isActive("/") ? "text-white" : "text-[#c7c7c7] hover:text-white"
            }`}
          >
            Work
          </Link>
          <Link
            to="/about"
            className={`leading-[1.6] transition-colors ${
              isActive("/about") ? "text-white" : "text-[#c7c7c7] hover:text-white"
            }`}
          >
            About
          </Link>
          <Link
            to="/certificates"
            className={`leading-[1.6] transition-colors ${
              isActive("/certificates") ? "text-white" : "text-[#c7c7c7] hover:text-white"
            }`}
          >
            Certificates
          </Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#0a0a0a] border-t border-[#484848]/50">
          <div className="container mx-auto px-4 py-6 flex flex-col gap-4 font-['JetBrains_Mono'] font-medium text-[16px]">
            <Link
              to="/"
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`leading-[1.6] transition-colors py-2 ${
                isActive("/about") ? "text-white" : "text-[#c7c7c7]"
              }`}
            >
              About
            </Link>
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`leading-[1.6] transition-colors py-2 ${
                isActive("/certificates") ? "text-white" : "text-[#c7c7c7]"
              }`}
            >
              Certificates
            </Link>
