...
function FormInput({ label, type = "text", id }: { label: string; type?: string; id: string }) {
  return (
    <div className="flex flex-col gap-[8px] w-full">
      <label htmlFor={id} className="font-['JetBrains_Mono'] font-medium leading-[1.6] text-[#c7c7c7] text-[16px]">
        {label}
      </label>
      <input
        type={type}
        id={id}
        className="bg-[#1a1a1a] rounded-[4px] px-[16px] py-[12px] font-['JetBrains_Mono'] font-normal leading-[1.5] text-[18px] text-white outline-none focus:ring-2 focus:ring-[#d3e97a] transition-all"
      />
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col gap-[8px] w-full">
      ...
      <textarea
        id={id}
        rows={6}
        className="bg-[#1a1a1a] rounded-[4px] px-[16px] py-[12px] font-['JetBrains_Mono'] font-normal leading-[1.5] text-[18px] text-white outline-none focus:ring-2 focus:ring-[#d3e97a] transition-all resize-none"
      />
    </div>
  );
}
    ...
    <footer id="contact" className="container mx-auto px-4 md:px-[60px] py-[80px]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[24px]">
        ...
        <div className="flex flex-col justify-between gap-12">
              ...
              <div className="flex flex-col gap-[8px]">
                <div className="flex gap-[3px] items-center flex-wrap">
                  ...
                  <a
                    ...
                    className="font-['JetBrains_Mono'] font-normal leading-[1.5] text-[16px] md:text-[18px] text-white border-b border-[#d3e97a] hover:text-[#d3e97a] transition-colors"
                  >
          ...
          <p className="font-['JetBrains_Mono'] font-medium leading-[1.6] text-[#c7c7c7] text-[16px]">
            © 2023 Robert Garcia
          </p>
        </div>
        ...
        <div className="flex flex-col">
          <form onSubmit={handleSubmit} className="flex flex-col gap-[40px]">
            ...
            >
              <p className="font-['JetBrains_Mono'] font-bold leading-none text-[#0a0a0a] text-[16px] uppercase">
                Submit
              </p>
            </button>
          </form>
